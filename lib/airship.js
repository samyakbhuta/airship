...
, feedback: function (since) {
  ...
  /**
   * Returns apids (android devices) that are registered with Urban Airship account.
   *
   * @param {Object} options Use to set limit to the apids returned in reply
   *
   * @see https://docs.urbanairship.com/display/DOCS/Server%3A+Android+Push+API
   */
, apids: function (options) {
    var path = u.apidsPath();
